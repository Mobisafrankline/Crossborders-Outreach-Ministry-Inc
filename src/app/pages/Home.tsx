import { Heart, Users, Globe, CheckCircle2, ArrowRight, Quote } from "lucide-react";
  ...
  const programs = [
    {
      ...
      image: "https://images.unsplash.com/photo-1710092784814-4a6f158913b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
      link: "/food-support"
    },
    {
      title: "Education Support",
      description: "Empowering children through quality education, school supplies, and learning resources.",
      image: "https://images.unsplash.com/photo-1770843093640-c44ae557928b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
      link: "/education"
    },
    {
      title: "Healthcare Outreach",
      description: "Delivering essential medical care, preventive health services, and wellness programs.",
      image: "https://images.unsplash.com/photo-1770221797840-8f5a095ad7ae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
      link: "/healthcare"
    },
    {
      title: "Economic Empowerment",
      description: "Creating sustainable livelihoods through skills training and microfinance support.",
      image: "https://images.unsplash.com/photo-1752650736246-abae155278be?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
      link: "/economic"
    }
  ];
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {programs.map((program, idx) => (
              <div key={idx} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow group">
